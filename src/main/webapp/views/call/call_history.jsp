    ...
    <div class="client">
		...
		<div id="container">
			<div class="row">
				...
				<h2 id="call_hist_title">查询通话记录</h2>
				...
				<div id="cond_div" class="row">	
					<form class="form-inline">
						<div class="form-group">
							<label><font class="tip_font">开始时间(默认值1月前)：</font></label>
						...
						<div class="form-group">
							<label><font class="tip_font">截至时间(默认值当前)&nbsp;&nbsp;：</font></label>
							<input type="date" class="form-control" name="end_date" id="end_date" />
							<input type="time" class="form-control" name="end_time" id="end_time" />
						</div>
						<button type="button" id="get_ch_submit" class="btn btn-info">
							查&nbsp;&nbsp;询
						</button>
					</form>	
				</div>
