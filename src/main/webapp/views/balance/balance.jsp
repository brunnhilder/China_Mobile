...
<head>
	...
	<!-- 引入该页面的js代码 -->
	<script type="text/javascript" src="/js/balance/balance.js"></script>
	<!-- 引入该页面的css代码 -->
	<link rel="stylesheet" type="text/css" href="/css/balance/balance.css"></link>
    ...
    <div class="client">
		...
		<div id="container">
			<div class="row">
				...
				<h2 id="call_hist_title">查询话费余额</h2>
				...
				<div id="content" class="col-md-6 col-md-offset-3">
					<div id="balance">
						<font color="black">
							<span class="col-sm-4 control-label no-padding-right" id="normal_balance_tip"></span>
						</font>
						<font color="red">
							<span class="col-sm-4 control-label no-padding-right" id="balance_tip"></span>
						</font>
						<button type="button" id="balance_sub" class="btn btn-info">
							查&nbsp;&nbsp;询
						</button>	
					</div>
				</div>
